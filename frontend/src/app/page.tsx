...
// klären auf welchem localhost das läuft
...
const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
  ...
  return (
    <main className="flex justify-center items-center  flex-col">
      <form className="border-2 p-6 flex flex-col items-center gap-10 rounded-xl min-w-full "  onSubmit={handleSubmit}>
        <h1 className="text-3xl">Create Contact</h1>
        <section className="min-w-full min-h-full flex flex-col gap-10">
          <div className="border-b">
            <input type="text" placeholder="Name:" className="text-2xl"             value={name}
            onChange={(e) => setName(e.target.value)}/>
          </div>
          <div className="border-b">
            <input type="text" placeholder="Telephone:" className="text-2xl"             value={telephone}
            onChange={(e) => setTelephone(e.target.value)} />
          </div>
          <div className="border-b">
            <input type="text" placeholder="Address:" className="text-2xl"             value={adress}
            onChange={(e) => setAdress(e.target.value)}/>
          </div>
          <div className="border-b">
            <input type="text" placeholder="Category:" className="text-2xl"              value={category}
